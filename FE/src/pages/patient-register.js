...
export async function renderPatientRegister() {
    ...
    `;
        ...
        // Password strength logic (step 2)
        if (currentStep === 2) {
          ...
          <div class="bg-white shadow-sm border border-slate-200 rounded-xl p-6 md:p-8">
            ...
            <div class="space-y-6">
              ...
              <div class="flex items-start gap-3">
                ...
                <div class="text-sm">
                  <label class="font-medium text-slate-700" for="agreement">I have read and agree to the Terms of Service and Privacy Policy. *</label>
                  <p class="text-slate-500 font-normal">By checking this box, you consent to the collection and use of your medical data as described above.</p>
                </div>
              </div>
            </div>
          </div>
