    ...
    <div style="max-width: 1000px; margin: 0 auto;">
          ...
          <table class="table" style="margin: 0;">
            ...
            <tbody>
              ${ocrResult.fields.map(f => `
                <tr style="${f.needsReview ? 'background: var(--warning-light);' : ''}">
                  <td class="text-sm" style="font-weight: 600;">${f.label}</td>
                  <td>
      ...
      <div class="card">
        ...
        <div class="card-body" style="text-align: center; padding: 40px;">
          <div style="border: 2px dashed var(--gray-300); border-radius: var(--radius-md); padding: 40px; color: var(--gray-400);">
            <span class="material-icons-outlined" style="font-size: 48px;">document_scanner</span>
            <p class="text-sm" style="margin-top: 8px;">Original prescription scan preview</p>
          </div>
        </div>
      </div>
    </div>
